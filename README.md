# Console Mangena Portfolio (React)
...
This is the portfolio website for Console Mangena, based on the open-source React portfolio template. Styling and all pages (Home, Works, About, Contact, Resume) are preserved.

Edit content in `src/settings/resume.json` (name, title, description, socials) and images under `src/assets/`.
